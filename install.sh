...
echo -e "    ${CYAN}claude-switch save boss${RST}       ${DIM}# save current account${RST}"
echo -e "    ${CYAN}claude-switch login${RST}           ${DIM}# add another account${RST}"
echo -e "    ${CYAN}claude-switch use${RST}             ${DIM}# interactive switcher${RST}"
echo ""
